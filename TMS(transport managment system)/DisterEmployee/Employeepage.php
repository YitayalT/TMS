...
<td><img src="../images/b4.jpg" height="80px" width="150px"/>	
	...
	<div id="sidebar1">
	<div id="admin">
<ul><li><a><?php echo htmlspecialchars($lang['dister']);?></a></li></ul>
	<ul>
	<li><a href="ScheduleUpdatesearch.php"target="myframe"><?php echo htmlspecialchars($lang['control']);?></a></li>
	</ul>
	<ul>
	<li><a href="filter.php"target="myframe"><?php echo htmlspecialchars($lang['report']);?></a></li>
	</ul>
	<ul>
