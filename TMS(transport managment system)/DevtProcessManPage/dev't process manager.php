...
<td><img src="../images/b4.jpg" height="80px" width="150px"/>	</td></tr></table></header>
	...
	<div id="sidebar1">
	<div id="admin">
<ul><li><a><?php echo htmlspecialchars($lang['dev']);?></a></li></ul>
	<ul>
	<li><a href="associationregistration.php"target="myframe"><?php echo htmlspecialchars($lang['assregister']);?></a></li>
	</ul>
	<ul>
	<li><a href="Viewtorequesttoapprove.php"target="myframe"><?php echo htmlspecialchars($lang['approved']);?></a></li>
	</ul>
